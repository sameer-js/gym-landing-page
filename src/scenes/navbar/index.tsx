            ...
            <div className={`${flexBetween} mx-auto w-5/6`}>
                <div className={`${flexBetween} w-full gap-16`}>
                    ...
                    <div className={`${flexBetween} w-full`}>
                        ...
                        <button className="rounded-full p-2 bg-secondary-500 hover:bg-primary-500 hover:text-white transition duration-300" onClick={()=> setIsMenuToggled(!isMenuToggled)}>
